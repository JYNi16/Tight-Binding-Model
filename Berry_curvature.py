...
from Haldane_model import Honeycomb, stripe, Wely
...
colors2 = [(0.9, 0.9, 0.9), (1, 0, 0)]  #乳灰色到红色
colors1 = [(0, 0, 1), (0.9, 0.9, 0.9)]  # 乳灰色到蓝色
    
colors3 = [(0.0, 0.0, 1.0), (0.9, 0.9, 0.9), (1, 0.0, 0.0)]  #蓝色到乳灰色到红色
colors4 = [(0.0, 0.0, 1.0), (0.9, 0.9, 0.9), (0.9, 0.9, 0.9), (1, 0.0, 0.0)]  #蓝色到乳灰色到红色
colors5 = [(0.0, 0.0, 1.0), (0.9, 0.9, 0.9), (0.9, 0.9, 0.9), (0.9, 0.9, 0.9), (1, 0.0, 0.0)]  #蓝色到乳灰色到红色
    
cmap_name = 'custom_blue_red'
cm3 = LinearSegmentedColormap.from_list(cmap_name, colors3, N=256)
...
def plot_berry():
    ...
    plt.pcolormesh(X,Y,Z,  cmap=cm3, shading='gouraud')
